          ...
          <div className="col-md-9 col-lg-10">
            <div className="bg-white p-4 shadow rounded">
              ...
              <div className="d-flex justify-content-end gap-2">
                <button disabled={page === 1} onClick={() => setPage(page - 1)} className="btn btn-sm btn-outline-primary">Prev</button>
                <span>Page {page} of {totalPages}</span>
                <button disabled={page === totalPages} onClick={() => setPage(page + 1)} className="btn btn-sm btn-outline-primary">Next</button>
              </div>
