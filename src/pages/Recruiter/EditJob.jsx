              ...
              <div className="card p-4 shadow">
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    {logoPreview && <img src={logoPreview} style={{width:100}} />}
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <input className="form-control" name="key_skills" value={form.key_skills || ""} onChange={handleChange} />
                  </div>
                  ...
                  <div className="col-md-4">
                    ...
                    <input className="form-control" name="working_hours" value={form.working_hours || ""} onChange={handleChange} />
                  </div>
                  ...
                  <div className="col-md-4">
                    ...
                    <select className="form-control" name="employment_type" value={form.employment_type || ""} onChange={handleChange}>
                  ...
                  <div className="col-md-4">
                    ...
                    <select className="form-control" name="work_mode" value={form.work_mode || ""} onChange={handleChange}>
                  ...
                  <div className="col-md-3">
                    ...
                    <input className="form-control" name="overtime" value={form.overtime || ""} onChange={handleChange} />
                  </div>

                  <div className="col-md-3">
                    <label>Cab Facility</label>
                    <input className="form-control" name="cab_facility" value={form.cab_facility || ""} onChange={handleChange} />
                  </div>

                  <div className="col-md-3">
                    <label>Skills</label>
                    <input className="form-control" name="skills_required" value={form.skills_required || ""} onChange={handleChange} />
                  </div>

                  <div className="col-md-3">
                    <label>Language</label>
                    <input className="form-control" name="language_required" value={form.language_required || ""} onChange={handleChange} />
                  </div>
                  ...
                  <div className="col-md-3">
                    ...
                    <input className="form-control" name="interview_mode" value={form.interview_mode || ""} onChange={handleChange} />
                  </div>
